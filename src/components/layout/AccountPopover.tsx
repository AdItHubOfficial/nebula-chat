        ...
        <div className="px-3 pb-3">
          ...
          <div className="rounded-xl bg-black/25 p-3">
            <div className="flex items-center gap-1.5">
              ...
              <RoleBadges founder={user.founderBadge} owner={owner || user.ownerBadge} coOwner={user.coOwnerBadge} admin={admin || user.adminBadge} verified={user.verified} og={user.og} size={16} />
            </div>

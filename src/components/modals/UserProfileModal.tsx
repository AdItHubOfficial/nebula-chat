          ...
          <div className="px-6 pb-6">
            ...
            <div className="rounded-2xl bg-black/20 p-4">
              <div className="flex items-center gap-2">
                ...
                <RoleBadges founder={user.founderBadge} owner={badges.owner || user.ownerBadge} coOwner={user.coOwnerBadge} admin={badges.admin || user.adminBadge} verified={user.verified} og={user.og} size={18} />
              </div>
